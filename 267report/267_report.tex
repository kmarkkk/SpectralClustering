...
As we have the Laplacian matrix $L$, the next step is to find its eigenvetors to project data points into lower dimensions. A quick research through the existing sparase eigensolvers online pointed us to PARPACK (xxx), a parallel ARPACK implementiation based on MPI.\\
